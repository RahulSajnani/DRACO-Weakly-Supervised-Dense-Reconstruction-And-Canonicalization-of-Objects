...
class ResNetUNet34(nn.Module):
    ...
    def __init__(self, pretrained = True):
        ...
        if pretrained:
            ...
            self.base_model = models.resnet34(pretrained=pretrained, norm_layer = nn.InstanceNorm2d)
...
class NOCS_decoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.upsample = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)
        self.conv_up4 = convrelu_nocs(512, 512, 3, 1)
        self.conv_up3 = convrelu_nocs(512, 256, 3, 1)
        self.conv_up2 = convrelu_nocs(256, 256, 3, 1)
        self.conv_up1 = convrelu_nocs(256, 128, 3, 1)
        self.conv_up0 = convrelu_nocs(128,  64, 3, 1)
...
if __name__=="__main__":
    ...
    model = ResNetUNet34(pretrained=True)
    ...
    print(depth.shape, encoded_features.shape)
