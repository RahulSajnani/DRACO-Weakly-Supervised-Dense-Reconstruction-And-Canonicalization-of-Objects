...
class CarsLoader(object):
    ...
    def load_sample(self, target_frame_id):
        color00_img_seq, mask_img_seq, nox00_img_seq, depth_img_seq, extrinsics_seq, keypoints_seq, c3dpo_cam_coords_seq, c3dpo_rotation_seq = self.load_image_sequence(target_frame_id)
        sample = {}
        sample['color00_img_seq']       = color00_img_seq
        sample['nox00_img_seq']         = nox00_img_seq
    ...
    def load_image_sequence(self, target_frame_id):
        ...
        for offset in range(-half_offset, half_offset+1, self.sample_gap):
            ...
            current_nox00_img       = imageio.imread(current_nox00_img_file)
            ...
            nox00_img_seq.append(current_nox00_img)
        ...
        return color00_img_seq, mask00_img_seq, nox00_img_seq, depth_img_seq, extrinsics_seq, keypoints_seq, c3dpo_cam_coords_seq, c3dpo_rotation_seq
